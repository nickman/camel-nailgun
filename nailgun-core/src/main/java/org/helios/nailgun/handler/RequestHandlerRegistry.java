 ...
 * <p><code>org.helios.nailgun.handler.RequestHandlerRegistry</code></p>
 */
...
public class RequestHandlerRegistry {
	...
	private final Map<String, NailgunRequestHandler> requestHandlers = new ConcurrentHashMap<String, NailgunRequestHandler>();
	 ...
	 */
	public void register(NailgunRequestHandler requestHandler, String... commandNames) {
	 ...
	 */
	public void remove(Class<? extends NailgunRequestHandler> clazz) {
		if(clazz==null) throw new IllegalArgumentException("The passed request handler class was null", new Throwable());
		Set<String> removes = new HashSet<String>();
		for(Map.Entry<String, NailgunRequestHandler> entry: requestHandlers.entrySet()) {
	 ...
	 */
	public NailgunRequestHandler lookup(String commandName) {
		...
		NailgunRequestHandler handler = requestHandlers.get(commandName.trim());
	 ...
	 * @return The looked up request handler or null if one was not found
	 */
	public NailgunRequestHandler lookup(NailgunRequest request) {
