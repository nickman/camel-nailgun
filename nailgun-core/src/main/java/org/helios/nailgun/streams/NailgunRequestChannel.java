...
/**
 * <p>Title: NailgunRequestChannel</p>
 * <p>Description: A channel wrapper that provides a shortcut for passing a NailgunRequest from the decoder to a request handler without
 * serializing. </p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>org.helios.nailgun.streams.NailgunRequestChannel</code></p>
 */

public class NailgunRequestChannel implements LocalServerChannel {
	/** The delegate channel */
	private final LocalServerChannel innerChannel;
	/** The request to deliver to the request handler */
	private NailgunRequest request = null;

	/**
	 * Creates a new NailgunRequestChannel
	 * @param innerChannel The real channel that this wrapper delegates to 
	 */
	public NailgunRequestChannel(LocalServerChannel innerChannel) {
	 ...
	 */
	void setRequest(NailgunRequest request) {
