 ...
 * <p>Description: A stream processor that receives channel buffers from the {@link NailgunRequestDecoder} and processes
 * them in its own pipeline, delivering the decoded output to the request handler.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>org.helios.nailgun.streams.StreamProcessorPipeline</code></p>
 */
